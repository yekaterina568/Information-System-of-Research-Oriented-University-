...
public class Teacher extends Employee implements Serializable, Comparable<Teacher> {
    ...
    public Teacher(String id,String name,String login, String password, String email, double salary, TeacherTitle title) {
    ...
    public void putMark(Student student, Course course, Mark mark) {
        ...
        System.out.println("Mark recorded for " + student.getName()  + " in " + course.getCourseName());
    }
    ...
    public void viewStudents(Course course) {
        ...
        for (Student s : course.getStudents()) {
            System.out.println("  " + s.getName()  + " | GPA: " + String.format("%.2f", s.getGPA()));
        }
    }
    ...
    public void receiveRating(int rating) {
        if (rating < 1 || rating > 10) {
            System.out.println("Invalid rating. Must be 1-10.");
            return;
        }
        ratings.add(rating);
        System.out.println("Rating of " + rating + " recorded for " + getName());
    }
    ...
    public String toString() {
        return title + " " + getName()  + " | Avg Rating: " + String.format("%.1f", getAverageRating());
    }
}